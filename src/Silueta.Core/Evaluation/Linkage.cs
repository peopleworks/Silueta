...
public static class Linkage
{
    ...
    [
        "Places: a street address is found only as the postal standards write it, a city only before a state or from the lineage's list, and a postal code only after \"ZIP\", \"código postal\" or a state. Every place that survives — and the state and three ZIP digits Safe Harbor keeps — goes uncounted here.",
